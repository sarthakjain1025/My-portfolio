        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              ...
              from Vellore Institute of Technology, Chennai. Coding has always
              been my forte and I have always been passionate about Web
              Development and have been working on projects for the past 2
              years.
              <br />
              <br />I am fluent in classics like
              <i>
                <b className="purple"> Java for programming </b>
              </i>
              <br />
              <br />
              ...
              <i>
                ...
                <b className="purple">Databases and backend.</b>
              </i>
              <br />
              <br />
